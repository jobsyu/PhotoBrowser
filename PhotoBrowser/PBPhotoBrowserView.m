...
@interface PBPhotoBrowserView()<UIScrollViewDelegate>
...
-(void)handleDoubleTap:(UITapGestureRecognizer *)recognizer
{
    ...
    if (self.scrollview.zoomScale <= 1.0) {
        ...
        CGFloat scaleX = touchPoint.x + self.scrollview.contentOffset.x;//需要放大的X点
        CGFloat scaleY = touchPoint.y + self.scrollview.contentOffset.y;//需要放大的Y点
...
-(void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder
{
    ...
    //添加进度指示器
    PBIndicatorView *indicatorView =[[PBIndicatorView alloc] init];
    indicatorView.viewMode = PBIndicatorViewModeLoopDiagram;
