...
@interface PBPhotoBrowser ()<UIScrollViewDelegate>
...
- (void)setUpFrames
{
    ...
    [_scrollView.subviews enumerateObjectsUsingBlock:^(PBPhotoBrowserView *obj, NSUInteger idx, BOOL *stop) {
...
-(void)addScrollView
{
    ...
    for (int i=0; i<self.imageCount; i++) {
        PBPhotoBrowserView *view = [[PBPhotoBrowserView alloc] init];
...
{
    PBPhotoBrowserView *view = (PBPhotoBrowserView *)recognizer.view;
...
- (void)saveImage
{
    ...
    PBPhotoBrowserView *currentView = _scrollView.subviews[index];
...
{
    PBPhotoBrowserView *view = _scrollView.subviews[index];
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    for (PBPhotoBrowserView *view in _scrollView.subviews) {
